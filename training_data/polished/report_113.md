...
## Executive Summary
This dataset is suitable for exploratory and predictive analysis in the **HR Attrition** domain. The estimated data quality score is **56/100**, which indicates a **low** readiness level for downstream analytics. With targeted preprocessing, target validation, and baseline benchmarking, the dataset can support KPI monitoring, signal ranking, and early-stage machine learning workflows.
...
The dataset contains approximately **30273 rows** and **16 columns**.  
...
- **JobRole**: estimated importance **0.4**
- **MonthlyIncome**: estimated importance **0.19**
