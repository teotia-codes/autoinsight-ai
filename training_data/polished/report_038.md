...
## Target Validation
The most likely target variable is **RetentionRisk**, and the inferred task type is **Classification**. Confidence in this target selection is **Moderate**, with ambiguity status set to **True**. The selected target is plausible but should be validated against stakeholder intent.

## Key Data Quality Findings
The dataset contains approximately **9073 rows** and **24 columns**.  
...
- **MonthlyCharges**: estimated importance **0.44**
- **Usage**: estimated importance **0.3**
- **ContractType**: estimated importance **0.29**
