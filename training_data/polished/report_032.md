...
The dataset contains approximately **8321 rows** and **25 columns**.  
...
- **OrderVolume**: estimated importance **0.39**
- **SupplierRegion**: estimated importance **0.39**
- **LeadTime**: estimated importance **0.25**
