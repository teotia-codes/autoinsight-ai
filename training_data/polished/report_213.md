...
## Target Validation
The most likely target variable is **Default**, and the inferred task type is **Classification**. Confidence in this target selection is **High**, with ambiguity status set to **False**. The target selection appears aligned with the likely business objective.

## Key Data Quality Findings
The dataset contains approximately **26707 rows** and **28 columns**.  
...
- **LatePayments**: estimated importance **0.33**
- **Income**: estimated importance **0.21**
