...
The dataset contains approximately **18705 rows** and **11 columns**.  
...
- **JobRole**: estimated importance **0.42**
- **JobSatisfaction**: estimated importance **0.32**
- **MonthlyIncome**: estimated importance **0.3**
